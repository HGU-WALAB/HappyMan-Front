...
const ApplicantsListItems = (props) => {
    ...
    const [selectedApplicant, setSelectedApplicant] = useState(null); // 선택된 사용자 정보
        ...
        () => [
            { accessor: "id", Header: "ID", show: false },
            {
                ...
                Cell: ({ row }) => {
                    return (
                        <div className="d-flex align-items-center">
                            <h5 className="mb-0" onClick={() => handleShowModal(row.original)} style={{ cursor: "pointer" }}>
                                {row.original.name}
                            </h5>
                        </div>
                    );
            ...
            <Modal show={showModal} onHide={handleCloseModal}>
                ...
                <Modal.Body>
                    {selectedApplicant && (
                        <div>
                            <p>
                                <strong>이름:</strong> {selectedApplicant.name}
                            </p>
                            <p>
                                <strong>학번:</strong> {selectedApplicant.uniqueId}
                            </p>
                            <p>
                                <strong>이메일:</strong> {selectedApplicant.email}
                            </p>
                            <p>
                                <strong>1전공:</strong> {selectedApplicant.major1}
                            </p>
                            <p>
                                <strong>상태:</strong> {selectedApplicant.applicationForm}
                            </p>
                        </div>
                    )}
                </Modal.Body>
