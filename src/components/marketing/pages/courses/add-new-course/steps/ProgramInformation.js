                                ...
                                <Row>
                                    ...
                                    <Col md={6} xs={12} className="mb-4">
                                        <Form.Group>
                                            ...
                                            <Form.Control type="text" placeholder="숫자만 기입" id="program_quota" name="program_quota" value="30" disabled />
                                        </Form.Group>
                                    </Col>
                                    ...
                                    <Col md={6} xs={12} className="mb-4">
                                        <Form.Group controlId="program_category">
                                            ...
                                            <select className="form-select" id="program_category" name="program_category" required disabled value="캠프">
                                    ...
                                    <Col md={6} xs={12} className="mb-4">
                                        <Form.Group>
                                            ...
                                            <Form.Control type="text" placeholder="담당자 이름을 입력하세요." name="manager_name" value="임연규" disabled />
                                        </Form.Group>
                                    </Col>
