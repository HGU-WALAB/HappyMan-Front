                                                ...
                                                <Col sm={12} md={12} className="mb-4 ">
                                                    <Form.Group controlId="nameoncard">
                                                        ...
                                                        {applicantInformation[0].status === 0 ? (
                                                            ...
                                                            <div>
                                                                {applicantInformation[0].name}/ {applicantInformation[0].student_id} /{" "}
                                                                {applicantInformation[0].department}/{applicantInformation[0].major1}
                                                            </div>
                                                        )}
                                                    </Form.Group>
                                                </Col>
